		...
		<form name="RegistrationForm" action="reg" method="post">
			...
			<table align="center">
				...
				<tr> <td class="licenseStyle"> IMPORTANT! PLEASE READ CAREFULLY! BY COPYING, OR USING OUR FORUM(S)IN ANY MANNER, YOU AGREE TO BE BOUND BY THE TERMS OF THIS AGREEMENT AND PRIVACY POLICY.
 			    ...
 			    <p align="center" > <td class="licenseStyle"> <input type="checkbox" value="I agree" name="checkbox"> I agree</td></p>
			
			<p align="center">
				<input src="http://www.topazlabs.com/mktg/emails/03-06-11/images/registerButton.jpg" type="image" alt="submit" value="Register"/> or <a href="login">Login to the Forum</a>
			</p>
